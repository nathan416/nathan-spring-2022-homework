...
def plot_line_graph_helper(graph_list, precision, value, success):
...
def plot_line_graph(precision, value):
    success, graph_list = calculate_square(value, SEED, precision)
    plot_line_graph_helper(graph_list, precision, value, success)

    
def main():
       plot_line_graph(5, 11)
       plot_line_graph(10, 11)
       plot_line_graph(20, 11)
       plot_line_graph(20, -1)
